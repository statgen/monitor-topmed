...
print "<h4>Use these links to look at NHLBI TopMed data</h4>" .
	"<ul>\n" .
	"<li><a href='genome.php' target='_genome'>Genome Sequence data pages</a><br/></li>\n" .
	"<li><a href='rnaseq.php' target='_rnaseq'>RNA Sequence data pages</a><br/></li>\n" .
	"<li><a href='methyl.php' target='_methyl'>Methylation data pages</a><br/></li>\n" .
